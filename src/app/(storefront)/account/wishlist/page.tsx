...
import { HeartIcon, StarIcon, CartIcon } from '@/components/ui/gamer-icons'
    ...
    return (
      <div>
        ...
        <div className="bg-white border border-stone-200 rounded-2xl p-16 text-center">
          <HeartIcon size={64} className="text-zinc-700 mx-auto mb-4" />
        ...
        {wishlist.map((p) => (
          ...
          >
            ...
            <div className="relative aspect-square bg-stone-100">
              ...
              >
                <HeartIcon size={16} className="text-amber-700 group-hover/heart:text-stone-900 fill-amber-400 group-hover/heart:fill-white" />
              </button>
            </div>
            ...
            <div className="p-3">
              ...
              <div className="flex items-center gap-1 mt-1.5">
                <StarIcon size={12} className="fill-amber-400 text-amber-700" />
